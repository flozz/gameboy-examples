...
if "%1" == "assets" (
    ...
    call %IMG2GB% tileset --output-c-file=src/tileset.c --output-header-file=src/tileset.h --output-image=src/tileset.png tileset.png
    call %IMG2GB% tilemap --output-c-file=src/window_tilemap.c --output-header-file=src/window_tilemap.h --name WINDOW_TILEMAP src/tileset.png window_tilemap.png
    goto end
)
