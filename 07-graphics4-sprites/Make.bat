...
if "%1" == "assets" (
    ...
    call %IMG2GB% tileset --output-c-file=src/player.sprites.c --output-header-file=src/player.sprites.h --output-image=src/player.sprites.png --alternative-palette --sprite8x16 --name PLAYER_SPRITES ./player.png
    goto end
)
