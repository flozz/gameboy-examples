...
if "%1" == "assets" (
    ...
    call %IMG2GB% tileset --output-c-file=src/tileset.c --output-header-file=src/tileset.h --output-image=src/tileset.png --deduplicate ./img.png
    call %IMG2GB% tilemap --output-c-file=src/tilemap.c --output-header-file=src/tilemap.h src/tileset.png ./img.png
    goto end
)
